...
<body>
	...
	<form id="modifyForm" action="${pageContext.request.contextPath}/restful/reply/${reply_view.bId}" method="post">
		<table class="table">
			...
			<tr>
				<td colspan="2"><input class="btn btn-primary" type="submit" value="답변">&nbsp;&nbsp;
					<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/restful/'">목록</button>
				</td>
			</tr>
		</table>
	</form>
